...
import { assertValidRating } from '../lib/reviews';
import type { SeedReviewInput } from '../reviews';
 ...
 */
export async function seedReviewsForCabin(
    ctx: MutationCtx,
    args: { cabinId: Id<'cabins'>; reviews: SeedReviewInput[] },
) {
