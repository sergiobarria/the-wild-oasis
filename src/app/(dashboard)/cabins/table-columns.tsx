...
import { CabinsTableMenu } from './table-menu';
import { Button } from '@/components/ui/button';
import { Cabins } from '@/lib/xata';

type CabinTableColumns = Omit<Cabins, 'description'>;
...
export const columns: ColumnDef<CabinTableColumns>[] = [
	...
	},
	{
		...
		cell: ({ row }) => {
			return <div className="text-right font-medium">{row.getValue('max_capacity')}</div>;
		}
	},
	{
		accessorKey: 'price',
