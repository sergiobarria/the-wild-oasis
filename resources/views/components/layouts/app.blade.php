    ...
    <div class="max-w-7xl mx-auto px-8 py-16 grid grid-cols-1 md:grid-cols-3 gap-12">
        ...
        <div>
            ...
            <ul class="space-y-2">
                ...
                <li><a href="{{ route('pages.about') }}" class="hover:text-accent transition-colors">About Us</a>
                </li>
                <li><a href="{{ route('pages.contact') }}" class="hover:text-accent transition-colors">Contact</a>
                </li>
            </ul>
        </div>
